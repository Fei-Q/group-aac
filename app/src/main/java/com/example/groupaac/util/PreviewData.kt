...
object PreviewData {
    val participants = listOf(
        ParticipantOverview("u1", "Alice", SignalType.HOLD_MY_TURN, SignalState.ACTIVE, 4, 0, "Sent a message", "2 min"),
        ParticipantOverview("u2", "Bob", null, null, 2, 0, "Shared photo", "8 min", isLowParticipation = true),
        ParticipantOverview("u3", "Eve", SignalType.HELP, SignalState.ACTIVE, 1, 2, "Asked for help", "1 min"),
